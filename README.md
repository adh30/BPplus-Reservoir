...
The method for reservoir analysis is based on the approach used in [Davies et al. 2009](https://doi.org/10.1152/ajpheart.00875.2009) and the method for wave intensity analysis is based on [Hughes et al. 2020](https://doi.org/10.3389/fphys.2020.00550). 

The code is written in Matlab R2021a (https://www.mathworks.com/) and aims to read BPplus files (\*.xml) obtained from version 1.0 (Cardioscope software version SW.R7.VME.037) to version 5.0 (software version 3.0.0.0) and exports results to Microsoft Excel (https://www.microsoft.com/). 
...
## Useful references
 ...
 - Hughes AD, Park C, Ramakrishnan A, Mayet J, Chaturvedi N, Parker KH. Feasibility of estimation of aortic wave intensity using non-invasive pressure recordings in the absence of flow velocity in man. Front. Physiol., 2020; 11: 550. https://doi.org/10.3389/fphys.2020.00550
