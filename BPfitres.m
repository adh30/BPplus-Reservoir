%% BPfitres - batch analysis of BPplus data using kreservoir_vXX by KHP
...
%% Versions
% v1.0 First stable version(03/01/20) based on fitres_v5 and uses kreservoir_v14
%%
function  [Tn_av, Pinf_av, P_av,Pr_av,Pn_av,...
    fita_av, fitb_av,rsq_av]=BPfitres(p_av,samplerate)
%%
